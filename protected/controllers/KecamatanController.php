...
class KecamatanController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Kecamatan']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->kode_kec));
		}
	...
	{
		$model =  Kecamatan::model()->findAllByAttributes(array('kode_kab_kota'=>$id));
		$centers = KabupatenKota::model()->findByPk($id);
		$this->render('profilKecamatan',array(
			'model'=>$model,
			'centers'=>$centers,
		));
	}
