...
class KabupatenKotaController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','profil'),
				'users'=>array('admin'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['KabupatenKota']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->kode_kab_kota));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('KabupatenKota');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['KabupatenKota']))
			$model->attributes=$_GET['KabupatenKota'];
	...
	{
		$model =  KabupatenKota::model()->findAllByAttributes(array('kode_prov'=>$id));
		$centers = Provinsi::model()->findByPk($id);
		$this->render('profilKabupatenKota',array(
			'model'=>$model,
			'centers'=>$centers,
		));
	}
